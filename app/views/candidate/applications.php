    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            <div class="card border-0 shadow-sm rounded-4 p-3 bg-white mb-4">
                ...
                <div class="nav flex-column nav-pills gap-1">
                    ...
                    <a class="nav-link active py-2.5 rounded-3 fw-semibold" href="<?php echo URL_ROOT; ?>/candidate/applications">
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                <div>
                    <h2 class="fw-extrabold mb-1">My Applied Vacancies</h2>
                    <p class="text-muted small mb-0">History and live updates for all your submitted job applications</p>
                </div>
                <a href="<?php echo URL_ROOT; ?>/jobs" class="btn btn-outline-primary px-4 py-2.5 rounded-3 fw-bold">
                    <i class="fa-solid fa-magnifying-glass me-2"></i> Find Vacancies
                </a>
            </div>
                    ...
                    <table class="table align-middle table-hover mb-0">
                        ...
                        <tbody class="small">
                            <?php if (empty($applications)): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">You haven't applied for any job vacancies yet.</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($applications as $app): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div><?php echo htmlspecialchars($app->location); ?></div>
                                            <span class="badge bg-light text-muted small"><?php echo htmlspecialchars($app->job_type); ?></span>
                                        </td>
